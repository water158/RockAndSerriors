...
bool GameAbout::init()
{
    ...
    //标题label
    CCLabelTTF* label_title = CCLabelTTF::create(pXmlparser->getString("menu_about")->getCString(), "Arial", 80);
    ...
    addChild(textBG);
    //文档内容
    CCLabelTTF* labelText = CCLabelTTF::create(pXmlparser->getString("about")->getCString(), "Arial", 40);
    ...
    //添加返回按钮
    CCMenuItemImage* btnBack = CCMenuItemImage::create("gameui/btnShare.png", "gameui/btnShare.png",this,menu_selector(GameAbout::backCallback));
...
void GameAbout::backCallback(CCObject* obj)
{
    //播放点击音效
